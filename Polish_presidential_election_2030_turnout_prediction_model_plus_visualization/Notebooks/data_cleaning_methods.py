...
def get_new_row_as_dict(county_name: str, target_row: pd.DataFrame, percentage: float) -> dict:
    """
    ...
    return {
        "county": county_name,
        "authorized_voters": int(target_row.iloc[0, 0] * percentage), 
        "votes_cast": int(target_row.iloc[0, 1] * percentage)
    }
